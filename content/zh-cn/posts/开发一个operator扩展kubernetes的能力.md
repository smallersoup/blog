...
![需要编写的一个go文件](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/aaf212f1784baa7822e1bb0de016ce6d.png)
...
![type.go中部分结构体定义](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/6382beca35cd180973cd70fa43ac5368.png)
...
```
执行后将生成以下代码：
![生成的代码](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/69df801cbe3242bea6ba9da61c68a4b2.png)
...
## operator主流程代码开发
![入口](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/f20ac248613110011b8cf36986e40589.png)
...
![key处理流程](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/5fd7c49bcfc70de6e7d9fbd8de520d68.png)
...
![deepcopy](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/ee67d136c2e36e15ed82d1ad6810a4de.png)

- 根据CRD构建Statefulset时，给Statefulset加OwnerReferences，这样在删除CRD的时候，可以设置是否级联删除statefulset。
![设置owner](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/0db4d1bcaeeb9ec9705e8179280b8463.png)
...
![1555136612836.png](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/1f90429967996d25dd48559a0a2b0b1e.png)
...
![kubeconfig文件](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/d59c7d952fbc155175fcef7d79006f30.png)
...
![启动了两个实例](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/eb384ce6cab46348268e41dc60fdcbed.png)

可以看到只有一个实例operator-manager-86d785b5fc-m5rgh在同步事件，处理业务：
![master实例正在处理业务并renew锁](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/250e2965d3d0f45acf0686574bbe3ad8.png)


operator-manager-86d785b5fc-sszj2实例一直在竞争尝试获取锁：
![slave实例正在尝试获取锁](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/c0146ea04e01ea9d2a31611e451ea0aa.png)


删除掉正在同步事件的实例operator-manager-86d785b5fc-m5rgh：
![删除掉master实例](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/9dd676c719a2c959a109b69cc7a4096b.png)


实例operator-manager-86d785b5fc-sszj2竞争获取到锁，开始处理业务逻辑：

![slave实例获取到锁，开始处理业务并renew锁](https://cdn.jsdelivr.net/gh/smallersoup/jsDelivr-cdn@main/blog/article/imgconvert-csdnimg/d906fee46d8c017ea2118200c899812f.png)
